...
import com.example.unitask_app.data.model.DeviceTokenRequest
...
class UserRepository @Inject constructor(
    ...
    suspend fun registerDeviceToken(deviceToken: String, deviceId: String = ""): Response<Unit> {
        return apiService.registerDeviceToken(DeviceTokenRequest(deviceToken = deviceToken, deviceId = deviceId))
    }

    suspend fun unregisterDeviceToken(deviceToken: String, deviceId: String = ""): Response<Unit> {
        return apiService.unregisterDeviceToken(DeviceTokenRequest(deviceToken = deviceToken, deviceId = deviceId))
    }
}
